...
![TruthLens app](screenshots/1.png)
...
|---|---|
| `person1_clickbait.py` | Article extraction + clickbait classification (DistilBERT) |
| `person2_verification.py` | Headline-article stance verification + evidence extraction |
| `person3_pipeline.py` | Research relevance scoring, summarization, and PDF report generation |
